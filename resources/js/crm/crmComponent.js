...
Vue.component(
    "app-nav-navbar",
    require("./Component/Views/Nav/NavBar").default
);
//Helper for front-end
Vue.component(
    "app-auth-log-reg",
    require("./Component/Views/Auth/LogReg").default
);
...
Vue.component(
    "app-agric-person",
    require("./Component/Views/Contacts/Person/AgricPersons").default
);
Vue.component(
...
Vue.component(
    "app-profile-investor-info",
    require("./Component/Views/Profile/InvestorInfo").default
);
Vue.component(
    "app-profile-agribusiness-info",
    require("./Component/Views/Profile/AgriBusinessInfo").default
);
Vue.component(
    "app-password-change",
...
Vue.component(
    'app-document',
    require("./Component/Views/Document/Document").default
);
//document modal
Vue.component(
    "app-document-modal",
    require("./Component/Views/Document/DocumentModal").default
);
Vue.component(
    "app-invoice-modal",
