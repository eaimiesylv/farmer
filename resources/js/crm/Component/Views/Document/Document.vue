...
import {formatDateTimeToLocal, formatted_date, time_format} from "../../../Helpers/helpers";
export default {
    name: "ListView",
    ...
    data() {
        return {
            ...
            activityModalId: "document-modal",
            ...
            options: {
                ...
                columns: [
                   /* {
                    ...
                    },
                    {
                        ...
                        key: "contextable",
                        type: "component",
                        componentName: "activity-details-from-related-to"
                        // modifier: (value, row) => {
                        ...
                        //             ? 'success'
                        //             : 'warning'}">${arr[arr.length - 1].toLowerCase()}
                        //         </span>
                        //
                    ...
                    /*{
                        ...
                        type: "custom-html",
                        key: "started_at",
                        modifier: (date, row) => (date ?
                            formatDateTimeToLocal(`${date} ${row.start_time}`) : "-"),
                    },
                    {
                        ...
                        key: "ended_at",
                        modifier: (date, row) => (date ?
                            formatDateTimeToLocal(`${date} ${row.end_time}`) : "-"),
                    },
                    {
                        title: this.$t("reminder"),
                        type: "custom-html",
                        key: "reminder_on",
                        modifier: (reminder_on, row) => (reminder_on ?
                            formatDateTimeToLocal(reminder_on) : "-"),
                    },
                    {
                        title: this.$t("action"),
                        type: "action",
                ...
                filters: [
                    ...
                    },
                    {
                        ...
                        key: "done_activity",
                        header: {
                            "title": this.$t("do_you_want_to_see_done_activity"),
                            "description": ""
                        },
                        option: [
                            {
                                id: 1,
                                name: this.$t("show_done_activity")
                            },
                        ],
                        listValueField: 'name'
                    },
        ...
        getAllActivities() {
            this.axiosGet(route('activity_types.index')).then((response) => {
                ...
                activityType.option = response.data.data.map((activities) => {
                    return {
                        id: activities.id,
                        value: activities.translated_name,
                    };
                });
            });
        },
